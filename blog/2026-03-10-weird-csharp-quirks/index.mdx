...
- **BannedApiAnalyzers** is a Roslyn analyzer that allows you to ban specific APIs. You can also add a suggestion for which API to use instead. 
...
**Content:** Jeremy. Proofread by [@CaringDev](https://github.com/CaringDev) and Claude (LLM by Anthropic)
